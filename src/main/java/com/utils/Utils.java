...
public class Utils {
	...
	// private static final DateFormat df1 = new
	// SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
	private static final DateTimeFormatter df2 = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");

	private static final List<Character> cyrillic = Arrays
			.asList(new Character[] { 'а', 'б', 'в', 'г', 'д', 'е', 'ё', 'ж', 'з', 'и', 'й', 'к', 'л', 'м', 'н', 'о', 'п',
					'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ь', 'ы', 'ъ', 'э', 'ю', 'я', ' ' });
	private static final List<String> latin = Arrays
			.asList(new String[] { "a", "b", "v", "g", "d", "e", "e", "zh", "z", "i", "j", "k", "l", "m", "n", "o", "p", "r",
					"s", "t", "u", "f", "h", "c", "ch", "sh", "shj", "", "ji", "j", "e", "yu", "ya", "_" });
