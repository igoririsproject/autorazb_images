...
public class MimeTypes {
	...
	public static final String MIME_APPLICATION_VND_MSEXCELX = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
	...
	public static final String MIME_APPLICATION_VND_MSWORDX = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
	...
	static {
		...
		mimeTypeMapping = new HashMap<String, String>() {
...

			{
				...
				put1("pot", MIME_APPLICATION_VND_MSPOWERPOINT);
				put1("pps", MIME_APPLICATION_VND_MSPOWERPOINT);
				put1("ppa", MIME_APPLICATION_VND_MSPOWERPOINT);
				put1("pptx", MIME_APPLICATION_VND_MSPOWERPOINTX);
				...
				put1("dot", MIME_APPLICATION_MSWORD);
				put1("docx", MIME_APPLICATION_VND_MSWORDX);
				put1("xls", MIME_APPLICATION_VND_MSEXCEL);
				put1("xlt", MIME_APPLICATION_VND_MSEXCEL);
				put1("xla", MIME_APPLICATION_VND_MSEXCEL);
				put1("xlsx", MIME_APPLICATION_VND_MSEXCELX);
	...
	public static String getExtension(String mimeType, boolean useDefault) {
		if (useDefault) {
			return extMapping.getOrDefault(mimeType.toLowerCase().trim(), mimeType.substring(mimeType.lastIndexOf("/") + 1));
		} else {
			return extMapping.get(mimeType.toLowerCase().trim());
		}
	}
	...
	public static String lookupMimeType(String ext) {
		return mimeTypeMapping.get(ext.toLowerCase().trim());
	}
}